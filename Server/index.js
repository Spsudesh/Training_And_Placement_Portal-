...
const noticeMailRoutes = require('./routes/tpo_routes/mail/notice_mail_routes');
...
app.use('/tpc/notices', requireAuth, requireRole('tpc'), noticeMailRoutes);
...
app.use('/tpo/notices', requireAuth, requireRole('tpo'), noticeMailRoutes);
